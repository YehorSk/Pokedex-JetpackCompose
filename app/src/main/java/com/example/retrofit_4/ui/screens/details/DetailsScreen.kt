...
@Composable
fun DetailsScreen(viewModel: DetailsViewModel,detailsUiState: DetailsUiState,modifier: Modifier = Modifier){
    when(detailsUiState){
        is DetailsUiState.Success -> DetailsFullScreen(pokemon = detailsUiState.pokemon,modifier = modifier)
...
@Composable
fun DetailsFullScreen(pokemon: PokemonStats,modifier: Modifier = Modifier){
    Column(
        modifier = modifier.fillMaxSize().verticalScroll(rememberScrollState()),
    ) {
        DetailsTopBar(pokemon)
...
@Composable
fun DetailsTopBar(pokemon: PokemonStats, modifier: Modifier = Modifier){
...
fun PokemonStatsBar(stat: Stats){
    Row(
        ...
        Text(text = stat.base_stat.toString())
    }
}
